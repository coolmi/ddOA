      ...
      dd.ready(function () {
        dd.biz.user.get({
          onSuccess: function (info) {
            // if (info.emplId === ding.GMK_LZL || info.emplId === ding.W3_CONCAT_DDID || info.emplId === ding.GMK_ZYL) {
//  正式机 只有李振龙，付明月拥有切换用户的权限
           if (info.emplId === ding.GMK_LZL || info.emplId === ding.W3_CONCAT_DDID || info.emplId === ding.GMK_ZBM || info.emplId === ding.GMK_CXN || info.emplId === ding.GMK_XCM || info.emplId === ding.GMK_ZYM || info.emplId === ding.GMK_YF || info.emplId === ding.GMK_LZH || info.emplId === ding.GMK_LZH || info.emplId === ding.GMK_GJH || info.emplId === ding.GMK_LHH || info.emplId === ding.GMK_ZYL || info.emplId === ding.GMK_001 || info.emplId === ding.GMK_002 || info.emplId === ding.GMK_003) {
